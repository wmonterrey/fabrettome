	                	...
	                	<div class="card-body">
		                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                		<div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${escuela.idUnico}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="codigoEscuela" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${escuela.codigo}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${escuela.usuarioRegistro}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${escuela.fechaRegistro}" /></strong></p>
			                      </div>
			                    </div>
		                	</form>
						</div>
