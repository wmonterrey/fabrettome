...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="escuelas" /></li>
        <!-- Breadcrumb Menu-->
        ...
        <div class="animated fadeIn">
          ...
          <div class="card">
            <div class="card-header">
              <img src="${logofab}" alt="<spring:message code="'title'" />" />&nbsp;<i class="fa fa-university"></i> <spring:message code="escuelas" />
                ...
                <tbody>
                	<c:forEach items="${escuelas}" var="escuela">
                		<tr>
                            ...
                            <td>
                                <a href="${fn:escapeXml(escuelaUrl)}" class="btn btn-outline-primary btn-sm"><i class="fa fa-search"></i></a>
                                <a href="${fn:escapeXml(editEscuela)}" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i></a>
                                <c:choose>
									<c:when test="${escuela.pasivo=='0'.charAt(0)}">
  ...
  <c:set var="escuelaEnabledLabel"><spring:message code="escuelaEnabled" /></c:set>
  <c:set var="escuelaDisabledLabel"><spring:message code="escuelaDisabled" /></c:set>
  ...
  <script>
  	...
  	if ("${escuelaHabilitado}"){
		toastr.info("${escuelaEnabledLabel}", "${nombreEscuela}", {
		    closeButton: true,
		    progressBar: true,
		  } );
	}
	if ("${escuelaDeshabilitado}"){
		toastr.error("${escuelaDisabledLabel}", "${nombreEscuela}" , {
		    closeButton: true,
		    progressBar: true,
		  });
	}
