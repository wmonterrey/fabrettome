        ...
        <div class="animated fadeIn">
          ...
          <div class="card">
            <div class="card-header">
              <img src="${logofab}" alt="<spring:message code="'title'" />" />&nbsp;<i class="fa fa-object-group"></i> <spring:message code="comunidades" />
                ...
                <tbody>
                	<c:forEach items="${comunidades}" var="comunidad">
                		<tr>
                            ...
                            <td><c:out value="${comunidad.departamento.nombreDepartamento}" /></td>
                            <c:choose>
