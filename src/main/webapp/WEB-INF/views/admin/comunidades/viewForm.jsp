	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <img src="${logofab}" alt="<spring:message code="'title'" />" />&nbsp;<i class="fa fa-map-o"></i>&nbsp;<strong><c:out value="${comunidad.nombreComunidad}" /></strong>
	                </div>
	                	<div class="card-body">
		                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${comunidad.departamento.nombreDepartamento}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
