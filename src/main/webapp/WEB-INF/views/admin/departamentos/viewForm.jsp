  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<spring:url value="/admin/departamentos/" htmlEscape="true "/>"><spring:message code="departamentos" /></a></li>
	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <img src="${logofab}" alt="<spring:message code="'title'" />" />&nbsp;<i class="fa fa-map-o"></i>&nbsp;<strong><c:out value="${departamento.nombreDepartamento}" /></strong>
	                </div>
	                	<div class="card-body">
		                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                		<div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${departamento.idUnico}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${departamento.usuarioRegistro}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${departamento.fechaRegistro}" /></strong></p>
			                      </div>
			                    </div>
		                	</form>
						</div>
