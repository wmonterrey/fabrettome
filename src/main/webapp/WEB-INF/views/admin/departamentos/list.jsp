...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="departamentos" /></li>
        <!-- Breadcrumb Menu-->
        ...
        <div class="animated fadeIn">
          ...
          <div class="card">
            <div class="card-header">
              <img src="${logofab}" alt="<spring:message code="'title'" />" />&nbsp;<i class="fa fa-map-o"></i> <spring:message code="departamentos" />
                ...
                <tbody>
                	<c:forEach items="${departamentos}" var="departamento">
                		<tr>
                            ...
                            <c:choose>
                                <c:when test="${departamento.pasivo=='0'.charAt(0)}">
                            ...
                            <td>
                                <a href="${fn:escapeXml(departamentoUrl)}" class="btn btn-outline-primary btn-sm"><i class="fa fa-search"></i></a>
                                <a href="${fn:escapeXml(editDepartamento)}" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i></a>
                                <c:choose>
									<c:when test="${departamento.pasivo=='0'.charAt(0)}">
  ...
  <c:set var="departamentoEnabledLabel"><spring:message code="departamentoEnabled" /></c:set>
  <c:set var="departamentoDisabledLabel"><spring:message code="departamentoDisabled" /></c:set>
  ...
  <script>
  	...
  	if ("${departamentoHabilitado}"){
		toastr.info("${departamentoEnabledLabel}", "${nombreDepartamento}", {
		    closeButton: true,
		    progressBar: true,
		  } );
	}
	if ("${departamentoDeshabilitado}"){
		toastr.error("${departamentoDisabledLabel}", "${nombreDepartamento}" , {
		    closeButton: true,
		    progressBar: true,
		  });
	}
