...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <!-- Main content -->
    <main class="main">
	  <spring:url value="/super/centros/guardarCentro/" var="saveCentroUrl"></spring:url>
  	  <spring:url value="/super/centros/" var="centroUrl"/>	
      <!-- Breadcrumb -->
      <ol class="breadcrumb">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <form action="#" autocomplete="off" id="add-centro-form">                      
	                    ...
	                    <div class="form-group row">
	                      <label class="col-md-3 col-form-label" for="comunidad"><strong><spring:message code="nombreComunidad" />&nbsp;</strong><i class="fa fa-hand-o-up"></i></label>
	                      <div class="col-md-9">
	                      	<fieldset class="form-group">
