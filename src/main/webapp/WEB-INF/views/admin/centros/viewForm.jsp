	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <img src="${logofab}" alt="<spring:message code="'title'" />" />&nbsp;<i class="fa fa-building"></i>&nbsp;<strong><c:out value="${centro.nombreCentro}" /></strong>
	                </div>
	                	<div class="card-body">
		                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                		<div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${centro.idUnico}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="class ni.org.fabretto.me.domain.catalogs.Comunidad" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${centro.comunidad.nombreComunidad}, ${centro.comunidad.municipio.nombreMunicipio}, ${centro.comunidad.municipio.departamento.nombreDepartamento}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="codigoCentro" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${centro.codigo}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${centro.usuarioRegistro}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${centro.fechaRegistro}" /></strong></p>
			                      </div>
			                    </div>
		                	</form>
						</div>
